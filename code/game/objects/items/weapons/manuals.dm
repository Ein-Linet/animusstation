...
//big pile of shit below.
	...
	dat = {"<html>
				...
				So thereТs 50 dead people lying on the floor, chairs are spinning like no tomorrow and you havenТt the foggiest idea of what to do? Not to worry! This guide is intended to teach you how to clone people and how to do it right, in a simple step-by-step process! If at any point of the guide you have a mental meltdown, genetics probably isnТt for you and you should get a job-change as soon as possible before youТre sued for malpractice.
				...
				The cloning machine does not like abiotic items. What this means is you canТt clone anyone if theyТre wearing clothes, so take all of it off. If itТs just one person, itТs courteous to put their possessions in the closet. If you have about seven people awaiting cloning, just leave the piles where they are, but donТt mix them around and for GodТs sake donТt let the Clown in to steal them.

				<a name='3'><H4>Step 3: Put body in cloning machine</H4>
				Grab the body and then put it inside the DNA modifier. If you cannot do this, then you messed up at Step 2. Go back and check you took EVERYTHING off - a commonly missed item is their headset.

				<a name='4'><H4>Step 4: Scan body</H4>
				Go onto the computer and scan the body by pressing СScan - <Subject Name Here>Т. If youТre successful, they will be added to the records (note that this can be done at any time, even with living people, so that they can be cloned without a body in the event that they are lying dead on port solars and didnСt turn on their suit sensors)! If not, and it says УError: Mental interface failure.Ф, then they have left their bodily confines and are one with the spirits. If this happens, just shout at them to get back in their body, click СRefreshС and try scanning them again. If thereТs no success, threaten them with gibbing. Still no success? Skip over to Step 7 and donСt continue after it, as you have an unresponsive body and it cannot be cloned. If you got УError: Unable to locate valid genetic data.У, you are trying to clone a monkey - start over.

				<a name='5'><H4>Step 5: Clone body</H4>
				Now that the body has a record, click ТView RecordsТ, click the subjectТs name, and then click СCloneТ to start the cloning process. Congratulations! YouТre halfway there. Remember not to СEjectТ the cloning pod as this will kill the developing clone and youТll have to start the process again.

				<a name='6'><H4>Step 6: Get clean SEs for body</H4>
				Cloning is a finicky and unreliable process. Whilst it will most certainly bring someone back from the dead, they can have any number of nasty disabilities given to them during the cloning process! For this reason, you need to prepare a clean, defect-free Structural Enzyme (SE) injection for when theyТre done. If youТre a competent Geneticist, you will already have one ready on your working computer. If, for any reason, you do not, then eject the body from the DNA modifier (NOT THE CLONING POD) and take it next door to the Genetics research room. Put the body in one of those DNA modifiers and then go onto the console. Go into View/Edit/Transfer Buffer, find an open slot and click УSEУ to save it. Then click СInjectorТ to get the SEs in syringe form. Put this in your pocket or something for when the body is done.

				<a name='7'><H4>Step 7: Put body in morgue</H4>
				Now that the cloning process has been initiated and you have some clean Structural Enzymes, you no longer need the body! Drag it to the morgue and tell the Chef over the radio that they have some fresh meat waiting for them in there. To put a body in a morgue bed, simply open the tray, grab the body, put it on the open tray, then close the tray again. Use one of the nearby pens to label the bed УCHEF MEATФ in order to avoid confusion.

				<a name='8'><H4>Step 8: Await cloned body</H4>
				Now go back to the lab and wait for your patient to be cloned. It wonТt be long now, I promise.

				<a name='9'><H4>Step 9: Use the clean SE injector on person</H4>
				Has your body been cloned yet? Great! As soon as the guy pops out, grab your injector and jab it in them. Once youТve injected them, they now have clean Structural Enzymes and their defects, if any, will disappear in a short while.

				<a name='10'><H4>Step 10: Give person clothes back</H4>
				Obviously the person will be naked after they have been cloned. Provided you werenТt an irresponsible little shit, you should have protected their possessions from thieves and should be able to give them back to the patient. No matter how cruel you are, itТs simply against protocol to force your patients to walk outside naked.

				<a name='11'><H4>Step 11: Send person on their way</H4>
				Give the patient one last check-over - make sure they donТt still have any defects and that they have all their possessions. Ask them how they died, if they know, so that you can report any foul play over the radio. Once youТre done, your patient is ready to go back to work! Chances are they do not have Medbay access, so you should let them out of Genetics and the Medbay main entrance.

				<p>If youТve gotten this far, congratulations! You have mastered the art of cloning. Now, the real problem is how to resurrect yourself after that traitor had his way with you for cloning his target.
...
/obj/item/weapon/book/manual/genetics
	name = "Practical genetics"
	icon = 'book_animus.dmi'
	icon_state ="bookGenetics"
	author = "Chandra Bolvitz"
	...
	dat = {"<html>
				...
				<H3>ѕрактическа€ генетика</H3>

				<i><b>ƒанна€ книга не €вл€етс€ руководством по использованию геномодифицирующего оборудовани€.</b></i>

				<br>Ёто справочник и путеводитель по ƒЌ  человека дл€ практикующих генетиков
				<br>—одержание:
				<ol>
					<li><a href='#1'>¬нешние изменени€ (UI)</a></li>
					<ol>
						<a href='#11'><li>ѕолный индекс блоков UI</li></a>
						<a href='#12'><li>ѕигментные системы rbg, rgb и homogenial</li></a>
						<a href='#13'><li>—качковые переходы</li></a>

					</ol>
					<li><a href='#2'> онструктивные изменени€ (SE)</a></li>
					<ol>
						<a href='#21'><li>ќбща€ теори€ SE</li></a>
						<a href='#22'><li>»ндекс опасных блоков SE</li></a>
						<a href='#23'><li>ѕсевдоэмбриональное развитие</li></a>
					</ol>

					<li><a href='#3'>”никальные энзимы (UE)</a></li>
				</ol>

				<a name='1'><H4>¬нешние изменени€</H4>
				„асть, именуема€ <b>универсальными идентификаторами (сокр. UI)</b> - это отдельно выделенна€ группа блоков ƒЌ , состо€ща€ из 39 элементарных частей. Ќа данный момент UI исследованны почти досконально.
				<a name='11'><br><u>ѕолный индекс блоков UI:</u>
				<li>Ѕлоки 1-3. ѕигментаци€ волос на голове. —истема rbg (см. "ѕигментационные системы")</li>

				<li>Ѕлоки 4-6. ѕигментаци€ волос€ного покрова на теле. —истема rbg</li>
				<li>Ѕлок 7. ÷вет кожи. —истема homogenial</li>
				<li>Ѕлоки 8-10. –адужна€ оболочка глаза. —истема rgb</li>
				<li>Ѕлок 11. ѕол. ‘актически принадлежит к SE (см. "ќбща€ теори€ SE")</li>
				<li>Ѕлок 12. –астительность на лице. ƒействуют скачковые переходы</li>
				<li>Ѕлок 13. –астительность на голове. ƒействуют скачковые переходы</li>


				<a name='12'><br><u>ѕигментные системы</u>
				<br>ѕри помощи современного оборудовани€ можно манипулировать содержанием 4 основных пигментов в человеческом теле: хиноном (красный, r), антоцианом (синим, b), хлорином (зелЄный, r) и меланином (чЄрный). —одержание каждого пигмента, кроме меланина, оцениваетс€ числом от 0 до 0FF согласно степени насыщенности, где 0 - полное отсутствие пигмента. —истемы rbg и rgb соответсвенно определ€ют взаиморасположение этих чисел в блоке.   примеру, €рко-жЄлтые волосы (rbg) - это 0FF 000 0FF, а €рко-синие глаза (rgb) - 000 000 0FF. —истема homogenial - это один блок меланина, оцениваемый по количеству от FFF до 050. 050 и менее - неестественно чЄрный цвет, нехарактерный даже дл€ коренных индусов, а FFF - это альбиносы.

				<a name='13'><br><u>—качковые переходы</u>
				<br>ѕро скачковые переходы говор€т, когда параметры измен€ютс€ не плавно, а резко, но регул€рно через какие-то промежутки. Ѕлоки развити€ волос имеют сложную систему. ѕо предварительным исследовани€м, период каждого скачка равен 100. Ќа эту тему исследований довольно мало, но известно, что дл€ блока выше F00 волосы полностью исчезают.

				<a name='2'><H4> онструктивные изменени€ (SE)</H4>
				Ёта группа генов, называемых <b>структурными энзимами (сокр. SE)</b> исследована гораздо меньше, чем UI. ќна состоит из 42 элементарных частей.
				<a name='21'><br><u>ќбща€ теори€ SE</u> гласит, что дл€ любого блока SE (и 11 блока UI) есть точка активизации.  ак нетрудно догадатьс€, ниже точки активизации ген себ€ не про€вл€ет, выше - про€вл€ет.   сожалению, найти эту точку пока не удалось, но дл€ всех нижеперечисленных блоков известно, что она совершенно точно лежит в промежутке от 6D6 до 92F. ƒл€ неисследованных блоков она, возможно, может выходить за эти пределы.

				<a name='22'><br><u>»ндекс опасных блоков SE</u>

				<br><b>¬нимание!</b> “щательно следите, чтобы все эти блоки лежали ниже точки активности!
				<li>Ѕлок 1. ¬ызывает полную слепоту</li>
				<li>Ѕлок 3. ¬ызывает дистрофию голосовых св€зок и может быть причиной эпилептического припадка</li>
				<li>Ѕлок 5. ѕровоцирует икоту и тремор кистей. ћожет быть причиной глухоты.</li>
				<li>Ѕлок 7. —индром “уррета и периодические потери сознани€</li>
				<li>Ѕлок 9. ќтказ вестибул€рного аппарата</li>

				<a name='23'><br><u>ѕсевдоэмбриональное развитие</u>
				<br>ќсобо стоит упом€нуть блок 14. Ћюбое его изменение вызывает тотальную перестройку организма, будто дл€ определЄнной стадии развити€ тела в утробе. ѕока этот блок действует в соответствии с общей теорией, и если ген "неактивен", то организм немедленно начинает стремитьс€ к обезь€ньему строению. »звестный генетик √ай —екампарий утверждал, впрочем, что один раз ему удалось получить жабры.

				<a name='3'><H4>”никальные энзимы (UE)</H4>
				—юда относ€тс€ все остальные, совершенно неисследованные гены. ¬не вс€ких сомнений, даже малейшее изменение UE ощутимо вли€ет на существо, но, к сожалению, систематизировать изменени€ не удалось. ќборудование дл€ работы с этими генами ещЄ только разрабатываетс€ на момент выхода этого справочника. “ем не менее, если ¬ы хотите создать клон кого-либо, игнорировать UE при переносе ни в коем случае нельз€. ¬ ином же случае, если ¬ы не хотите, чтобы объект ¬аших исследований путали с кем-то другим, не трогайте его!
...
/obj/item/weapon/book/manual/qm_index
	name = "Quartermaster Indexes"
	icon = 'book_animus.dmi'
	icon_state ="bookQM_index"
	author = "Bob Silvester"
	...
	dat = {"<html>
				...
				<body>
				<H3>Quartermaster Indexes</H3>
				<ol>
					<a href='#1'><li>Postmaster index</li></a>

					<a href='#2'><li>Delivery beacons</li></a>
					<a href='#3'><li>Patrol beacons</li></a>
					<a href='#4'><li>Other</li></a>
				</ol>
				<a name='1'><H4>Postmaster index</H4>

				<ol>

				<li>Atmospherics. <i></i></li>
				<li>Bar</li>
				<li>Canteen</li>
				<li>Cargo Bay</li>
				<li>CE Office</li>
				...
				<li>Engineering</li>
				<li>Fitness Room</li>
				<li>Heads of Staff Meeting Room</li>

				<li>HoP Office</li>
				<li>HoS Office</li>
				<li>Hydroponics</li>
				<li>Janitor Closet</li>
				<li>Kitchen</li>
				<li>Library</li>

				<li>Medbay</li>
				<li>Medbay Back Entrance</li>
				<li>Mining Department</li>
				<li>QM Office</li>
				<li>RD Office</li>
				<li>Research</li>
				...
				<a name='2'><H4>Delivery beacons</H4>
				<br>Note: In most cases delivery points are in zones of free access.
				...
				<li>Kitchen</li>
				<li>Medbay</li>
				<li>QM #1 (M.U.L.E home-points)</li>
				<li>QM #2</li>
				...
				<a name='3'><H4>Patrol beacons</H4>

				<br>In order of traversal.
				<br>є. Signal. <i>Location</i>

				<ol>
				<li>Dorm. <i>NE from Bridge</i></li>
				<li>EVA 2. <i>N from Bridge</i></li>
				<li>EVA. <i>NW from Brige</i></li>

				<li>Lockers. <i>N from Tool Storage</i></li>
				<li>CHW. <i>S from EVA</i></li>
				<li>QM. <i>E from QM Office</i></li>
				<li>AIW. <i>W from AI Upload</i></li>
				<li>AftH. <i>E from Robotics</i></li>

				<li>AIE. <i>E from AI Upload</i></li>
				<li>HOP. <i>E from HoP Office</i></li>
				</ol>

				<a name='4'><H4>Unused beacons</H4>
				<br>If you want to use these navigation beacons for M.U.L.E bots, change their frequency to 140.0

				<ol>

				<li>Bar</li>
				<li>Tool Storage</i></li>
				</ol>
