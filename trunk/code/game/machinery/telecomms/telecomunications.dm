...
// ### Syndicate Preset machines (Located at syndi mothership)###

/obj/machinery/telecomms/receiver/preset/syndi
	id = "Receiver"
	network = "syndicomm"
	autolinkers = list("bus")
	freq_listening = list(1337)

/obj/machinery/telecomms/bus/preset/syndi
	id = "Bus"
	network = "syndicomm"
	autolinkers = list("bus", "processor", "server")

/obj/machinery/telecomms/processor/preset/syndi
	id = "Processor"
	network = "syndicomm"
	autolinkers = list("processor")

/obj/machinery/telecomms/server/preset/syndi
	id = "Server"
	network = "syndicomm"
	autolinkers = list("server", "broadcaster")

/obj/machinery/telecomms/broadcaster/preset/syndi
	id = "Broadcaster"
	network = "syndicomm"
